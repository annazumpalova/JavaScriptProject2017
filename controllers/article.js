...
module.exports = {
    ...
    editPost: (req,res) => {
        ...
        if(!articleArgs.title){
            errorMsg='Article title cannot be empthy!';
        } else if(!articleArgs.content)
        {
            errorMsg='Article content cannoyt be empthy!'
        }
        ...
        if(errorMsg)
        {
            ...
            Article.update({_id: id}, {$set: {title: articleArgs.title, content: articleArgs.content}}).then(updatesStatus => {
